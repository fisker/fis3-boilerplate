...
var CHARSET = 'utf-8'
var fixConfig = require('./lib/fix-config.js')
var generateConfig = require('./lib/generate-config.js').cache
var pluginTypes = require('./lib/plugin-types.js')
var getPluginConfig = require('./lib/plugin-config.js')
...
var envData = require('./lib/env.js')(ENV, CONFIG, projectConfig)
generateConfig({
  data: envData,
...
require('./lib/fix-fis3-command-release.js').fix()
